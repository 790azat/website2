        ...
        <div class="grid gap-12 lg:grid-cols-12">
            <div class="lg:col-span-5">
                ...
                <p class="mt-5 max-w-sm leading-relaxed text-brand-200/80">
                    {{ __('Clear, research-driven guides to banking, investing, borrowing, and credit — written to help you make confident money decisions.') }}
                </p>
            ...
            <div class="grid gap-10 sm:grid-cols-2 lg:col-span-7 lg:grid-cols-3">
                <div>
                    <p class="text-xs font-bold tracking-[0.16em] text-zest-400 uppercase">{{ __('Topics') }}</p>
                ...
                <div>
                    ...
                    <ul class="mt-5 space-y-3 text-sm">
                        <li><a href="{{ route('articles') }}" wire:navigate class="text-brand-100/80 transition hover:text-white">{{ __('All Articles') }}</a></li>
                        <li><a href="{{ route('team') }}" wire:navigate class="text-brand-100/80 transition hover:text-white">{{ __('Our Editorial Team') }}</a></li>
                        <li><a href="{{ route('contact') }}" wire:navigate class="text-brand-100/80 transition hover:text-white">{{ __('Contact') }}</a></li>
                    </ul>
                </div>
                <div>
                    <p class="text-xs font-bold tracking-[0.16em] text-zest-400 uppercase">{{ __('Legal') }}</p>
                    <ul class="mt-5 space-y-3 text-sm">
