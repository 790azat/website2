...
1. Freeze credit reports when new credit is not needed.
2. Review credit reports regularly.
3. Monitor bank and credit-card transactions.
4. Use strong, unique passwords.
5. Enable multifactor authentication where available.
6. Keep operating-system and security software updated.
7. Investigate unfamiliar account activity promptly.
8. Report suspected identity theft through official channels.
