...
**Fraud:**
The consumer did not authorize the transaction.

**Billing error:**
The consumer authorized the purchase, but something about the billing may be incorrect, such as an incorrect amount or duplicate charge.

**Merchant dispute:**
The consumer authorized the purchase but has a problem with the product or service, such as non-delivery or failure to provide what was agreed.
